class ALU_test extends uvm_test;
		...
		ALU_env sa_env; // Pointer to the env
		//Class create
		...
		function void build_phase(uvm_phase phase);
			...
			sa_env = ALU_env::type_id::create(.name("sa_env"), .parent(this));
		...
		task run_phase(uvm_phase phase);
			...
			phase.raise_objection(.obj(this)); //Don't end the test until sequence ends
				sa_seq = ALU_sequence::type_id::create(.name("sa_seq"), .contxt(get_full_name())); //Creates a sequence, a Stim generator
